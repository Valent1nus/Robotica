...
from car_pkg.car_camera_driver import CarCamera
from car_pkg.road_camera_driver import RoadCamera
...
class SignalListener(Node):
    def __init__(self):
        ...
        self.signal = 0.0
        self.create_subscription(String, '/traffic_sign', self.signal_callback, 10)
...
class CarDriver:
    def init(self, webots_node, properties):
        ...
        self.road_camera = RoadCamera(self.__robot, self.__timestep)
        self.car_camera = CarCamera(self.__robot, self.__timestep)
